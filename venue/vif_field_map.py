...
VIF_FIELD_MAP = {
    ...
    'ins': {
        ...
        12: ('gl_start_date', format_datetime),
        14: ('abn', str),
        15: ('state', str)},
    'dis': {
        2: ('name', str),
    ...
    'mov': {
        ...
        7: ('length', int),
        8: ('first_date', format_datetime),
        9: ('last_date', format_datetime),
        10: ('end_no_free_list_date', format_datetime),
        11: ('synopsis', str),
        12: ('gateway_code', str),
        13: ('english_title', str),
        14: ('release_date', format_datetime),
        15: ('long_name', str),
    ...
    'tkt': {
        ...
        3: ('code', str),
        4: ('comment', str),
        5: ('commencement_date', format_datetime),
        6: ('expiry_date', format_datetime),
        7: ('key_1', int),
        8: ('key_2', int),
    ...
    'vch': {
        ...
        7: ('text_line_4', str),
        8: ('text_line_5', str),
        9: ('commencement_date', format_datetime),
        10: ('expiry_date', format_datetime),
        11: ('days_valid', int),
        12: ('valid_immediately', bool),
        13: ('redemption_expiry_date', format_datetime),
    ...
    'ssn': {
        ...
        7: ('reserved', str),
        8: ('start_time', format_datetime),
        9: ('accounting_date', format_datetime),
        11: ('trailers', int),
        12: ('print', int),
        ...
        41: ('venue_class', int),
        42: ('creation_datetime', format_datetime),
        43: ('last_modified_datetime', format_datetime),
        44: ('modified_by', str),
        45: ('times_modified', int),
        50: ('seats_available_to_3rd_party', int),
        51: ('is_rainout', bool),
        52: ('admission_time', format_datetime),
        53: ('admissions', int),
    ...
    'q30': {
        ...
        10: ('total_ticket_price', float),  # ex fees
    ...
    'p30': {
        ...
        5: ('movie_code', str),
        6: ('movie_name', str),
        7: ('session_start_time', format_datetime),
